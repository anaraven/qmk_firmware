...
[_ADJUST] = LAYOUT( // activable with rasie+lower
  ...
  ____,  AU_TOG,    ____, AU_ON, AU_OFF,  MU_TOG,  MU_MOD, _______, ____, ____, ____, KC_SLEP,
...
[_NUM] = LAYOUT(
  TO(_QWERTY),_______, KC_UP,_______, ____,  ____,  ____, KC_P7, KC_P8, KC_P9, KC_PSLS, _______,
  _______, KC_LEFT, KC_DOWN, KC_RGHT, ____,  ____,  ____, KC_P4, KC_P5, KC_P6, KC_PAST, KC_PEQL,
  _______, _______, _______, _______, ____,  ____,  ____, KC_P1, KC_P2, KC_P3, KC_PMNS, KC_PENT,
