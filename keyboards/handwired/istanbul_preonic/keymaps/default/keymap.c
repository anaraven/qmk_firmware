 ...
 * └───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┘ */
  ...
  _______, KC_LEFT, KC_DOWN, KC_RGHT, ____,  ____, KC_PMNS, KC_P1, KC_P2, KC_P3, KC_PDOT, _______,
  _______, _______,_______, _______,  ____,  ____, _______ ,KC_P0, KC_COMM, KC_PDOT, KC_PSLS, KC_PENT,
